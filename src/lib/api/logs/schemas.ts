...
/**
 * Input schema for getting logs with filtering and pagination
 */
...
/**
 * Input schema for deleting logs
 */
...
/**
 * Input schema for batch log entries
 */
