...
/**
 * Input schema for creating a calendar feed via tRPC
 */
...
/**
 * Input schema for updating a calendar feed via tRPC
 */
export const UpdateFeedInputSchema = z.object({
  feedId: z.string().uuid("Invalid feed ID"),
  data: CreateFeedInputSchema.partial(),
});

/**
 * Input schema for getting a feed by ID via tRPC
 */
...
/**
 * Input schema for getting all feeds via tRPC with filters
 */
...
/**
 * Input schema for batch updating feeds via tRPC
 */
...
/**
 * Input schema for deleting a feed via tRPC
 */
...
/**
 * Input schema for syncing feed events via tRPC
 */
