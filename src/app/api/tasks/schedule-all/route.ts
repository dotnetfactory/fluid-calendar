...
export async function POST(request: NextRequest) {
  try {
    ...
    // Return immediately, then push to GCal in the background.
    // The secondary dedup in getAllCalendarItems handles the window
    // before gcalEventId values are populated.
